...
if (!file_exists("custom/templates/".$templateset) || $templateset == "")
{
	if ($templateset != "")
	{
		fcLog("js.php", "Das Templateset '".$templateset."' existiert nicht!");
	}
...
elseif (file_exists("custom/templates/".$templateset."/js/".$file.".js"))

{
	include_once "custom/templates/".$templateset."/js/".$file.".js";
}
